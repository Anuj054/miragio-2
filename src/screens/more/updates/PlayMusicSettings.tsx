...
const PlayMusicSettings = ({ navigation }: Props) => {
                ...
                >
                    ...
                    >
                        ...
                        <View className="flex-1 items-center">
                            ...
                            >
                                {isHi ? 'संगीत सेटिंग्स' : 'Music Settings'}
                            </Text>
                        </View>
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                ...
                <View className="items-center justify-center" style={{ paddingVertical: height * 0.1 }}>
                    <Text style={{ color: Colors.light.placeholderColorOp70, fontSize: width * 0.045 }} className="text-center">
                        {isHi ? 'संगीत सेटिंग्स यहाँ दिखाई जाएंगी' : 'Music settings will be displayed here'}
                    </Text>
                </View>
            </ScrollView>
        </View>
...
export default PlayMusicSettings;
