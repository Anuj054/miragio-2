...
/**
 * Props interface for CustomRedGradientButton component
 */
interface CustomRedGradientButtonProps {
...
/**
 * CustomRedGradientButton - A reusable button component with red gradient background
 * 
 * Features:
 * - Red gradient background from light red to darker red
 ...
 */
const CustomRedGradientButton: React.FC<CustomRedGradientButtonProps> = ({
    text = 'Button',
    width = 200,
    height = 50,
    onPress,
    ...
    return (
        ...
        >
            <LinearGradient
                colors={['#FF6B6B', '#E53E3E']}    // Light red to darker red gradient
...
/**
 * StyleSheet for the CustomRedGradientButton component
 */
...
export default CustomRedGradientButton;
