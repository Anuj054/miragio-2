...
/**
 * Props interface for CustomOrangeGradientButton component
 */
interface CustomOrangeGradientButtonProps {
...
/**
 * CustomOrangeGradientButton - A reusable button component with orange gradient background
 * 
 * Features:
 * - Orange gradient background from light orange to darker orange
 ...
 */
const CustomOrangeGradientButton: React.FC<CustomOrangeGradientButtonProps> = ({
    text = 'Button',
    width = 200,
    height = 50,
    onPress,
    ...
    return (
        ...
        >
            <LinearGradient
                colors={['#FFA726', '#FF8A00']}    // Light orange to darker orange gradient
...
/**
 * StyleSheet for the CustomOrangeGradientButton component
 */
...
export default CustomOrangeGradientButton;
